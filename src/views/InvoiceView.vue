<template>
  <div v-if="currentInvoice" class="invoice-view container">
    <router-link
      ...
      :to="{ name: 'Home' } "
    >
      <img src="@/assets/icon-arrow-left.svg" alt="icon"> Go back
    </router-link>
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button v-if="currentInvoice.invoiceDraft || currentInvoice.invoicePaid" class="orange" @click="updateStatusToPending(currentInvoice.docId)">Pending</button>
      </div>
    </div>
...
export default {
    ...
    methods: {
      ...mapMutations(['SET_CURRENT_INVOICE', 'TOGGLE_INVOICE_FORM', 'TOGGLE_EDIT_INVOICE']),
